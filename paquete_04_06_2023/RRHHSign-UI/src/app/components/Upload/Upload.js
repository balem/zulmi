        ...
        return new Promise((resolve, reject) => {
            ...
            req.addEventListener("readystatechange", () => {
                ...
                if (req.readyState === 4 && req.status === 200) {
                    ...
                    } else if (responses.status == 'existe') {
            ...
            formData.append("start_date", Moment(state.start_pay_date).local(momentESLocale).format('YYYY-MM-DD'));
            formData.append("end_date", Moment(state.end_pay_date).local(momentESLocale).format('YYYY-MM-DD'));
            formData.append("fecha_de_pago", Moment(state.fecha_de_pago).local(momentESLocale).format('YYYY-MM-DD'));
            formData.append("creator", userName)
            formData.append("mail_creator", userEmail)
            ...
            if (file.type.indexOf('pdf') > -1) {
                ...
                uploadUrl = process.env.REACT_APP_API_HOST + "/upload/receivefile"
            }
