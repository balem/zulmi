...
function LoadLogsListItem(props) {
            ...
            <Paper className="p-12 mt-16">
                ...
                >
                 <div className="flex flex-1 flex-col relative overflow-hidden pl-8">
                     ...
                     <div className="flex flex-1 flex-col relative overflow-hidden pl-2">
                        <Typography
                            variant="subtitle2"
                            className="todo-title truncate"
                            color={"inherit"}
                        >
                            Nro. Rec.: {props.registro.nrorecibo}
                        </Typography>
                    ...
                    <div className="flex flex-1 flex-col relative overflow-hidden pl-2">
                        <Typography
                            ...
                            color={"inherit"}
                        >
                            Mes: {props.registro.mes_de_pago}
                        </Typography>
...
export default LoadLogsListItem;