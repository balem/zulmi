...
import "./UploadEmployeeCertificate.css";
...
export default function UploadEmployeeCertificate(props) {
        ...
        return new Promise((resolve, reject) => {
            ...
            req.addEventListener("load", event => {
                ...
                if (req.status == 200) {
                    ...
                    showSimpleMessage('success', response.data);
                } else {
                    showSimpleMessage('error', response.data);
                }
                handleUploadProgress(copy);                
            ...
            let uploadUrl = process.env.REACT_APP_API_HOST + (
                file.name.indexOf('zip') != -1 ?
                "/certificate/mass-upload"
                : "/certificate/upload"
            )
    ...
    return (
        <Paper className="p-12 mt-16">
            ...
            <Typography className="h4 mb-24">Subida de Certificado del Usuario</Typography>
            {renderIf(props.hasCert)(
                <Grid container spacing={3}>
                    <Grid item xs={12} md={12}>
                        <Typography className="h5 mb-24">El usuario ya tiene un certificado configurado.</Typography>
                    </Grid>
                </Grid>
            )}
            <Grid container spacing={3}>
