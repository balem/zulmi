...
import "./UploadEmployeeFirmaHolograph.css";
...
export default function UploadEmployeeFirmaHolograph(props) {
    ...
    function sendRequest(file) {
        ...
        return new Promise((resolve, reject) => {
            ...
            let uploadUrl = process.env.REACT_APP_API_HOST + (
                ...
                "/employees/upload-holographic-signature-masive"
                : "/employees/upload-holographic-signature-one"
            )
    ...
    return (
        <Paper className="p-12 mt-16">
            ...
            <Typography className="h4 mb-24">Subida de Firma Holografa del Usuario</Typography>
