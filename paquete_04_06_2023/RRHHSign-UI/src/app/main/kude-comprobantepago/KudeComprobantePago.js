            ...
            if (responseXMLDetails.status === 200) {
                ...
                responseXMLDetails.data.sort(
                    ...
                    var xmlDetailsProcessed = {
                        ...
                        ingresosNo: details.xmlDetails.ingresosNo === null ? 0 : details.xmlDetails.ingresosNo,
            ...
            if (resultSignature.status === 200) {
                ...
                if (resultSignature.data.status === "success") {
                    ...
                    if(userProfile!='funcionario'){
                        ...
                        console.log("Firma de empleado sin notificacion")
                    }
                                       ...
                                       {/*  <div className={clsx(classes.divider, "mx-48 w-px h-128 print:mx-16")} /> */}
                                        ...
                                        <div >
                                            ...
                                            <Typography color="textSecondary">
                                                ...
                                                <Typography color="textSecondary">
                                                    <span>Número Patronal IPS: </span> { ipsFormatter(561820025) } { /* company.ips */} 
                                                </Typography>
                                    ...
                                    <TableBody>
                                        ...
                                        {<TableBody>
                                            <TableRow>
                                                ...
                                                <TableCell  style={{ backgroundColor: "#c0c0c0",padding: "0", border: "solid 1px black", height:'18px',fontSize:"10px"}}>
                                                    TOTAL A ABONAR
                                                </TableCell>
