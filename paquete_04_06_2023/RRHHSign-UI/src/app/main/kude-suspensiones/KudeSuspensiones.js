...
function KudeSuspensiones(props) {
    ...
    const [xml, handleXml] = useState({
        sanciones: '',
        suspencion_judicial: 'Si',
        desde_fecha: '10/06/2020',
        hasta_fecha: '11/06/2020',
        motivo_suspension: 'AAAAA'
});
                        ...
                        <CardContent className="p-88 print:p-0">
                            ...
                            <div className="mt-44 print:mt-0">
                                ...
                                <Table className="simple">
                                    <TableBody>
                                        ...
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Suspención Judicial?</Typography>
                                            </TableCell>
                                            <TableCell align="right">
                                                {xml.suspencion_judicial}
                                            </TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell>
                                        ...
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Motivo Suspensión</Typography>
                                            </TableCell>
                                            <TableCell align="right">
                                                {xml.motivo_suspension}
                                            </TableCell>
                                        </TableRow>
                            ...
                            <Grid container spacing={3}>
                                ...
                                <Grid item xs={12} md={3}>
                                    <div className="mt-96 print:mt-0 print:px-16">
                                        {(<QRCode value={`${process.env.REACT_APP_MTESS_PORTAL_URL}/kudesuspensiones/${hashKude}`} />)}
                                    </div>
                                </Grid>
                            </Grid>
                        </CardContent>
...
export default KudeSuspensiones;
