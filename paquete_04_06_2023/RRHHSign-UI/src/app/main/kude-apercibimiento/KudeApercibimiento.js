...
function KudeApercibimiento(props) {
    ...
    const [xml, handleXml] = useState({
        sanciones: '',
        fecha_apercibimiento: '10/06/2020',
        motivo_apercibimiento: 'AAAAA'
});
                        ...
                        <CardContent className="p-88 print:p-0">
                            ...
                            <div className="mt-44 print:mt-0">
                                ...
                                <Table className="simple">
                                    <TableBody>
                                        ...
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Fecha Apercibimiento</Typography>
                                            </TableCell>
                                            <TableCell align="right">
                                                {xml.fecha_apercibimiento}
                                            </TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Motivo Apercibimiento</Typography>
                                            </TableCell>
                                            <TableCell align="right">
                                                {xml.motivo_apercibimiento}
                                            </TableCell>
                                        </TableRow>
                            ...
                            <Grid container spacing={3}>
                                ...
                                <Grid item xs={12} md={3}>
                                    <div className="mt-96 print:mt-0 print:px-16">
                                        {(<QRCode value={`${process.env.REACT_APP_MTESS_PORTAL_URL}/kudeapercibimiento/${hashKude}`} />)}
                                    </div>
                                </Grid>
                            </Grid>
                        </CardContent>
...
export default KudeApercibimiento;
