...
function KudePreavisos(props) {
    ...
    const [xml, handleXml] = useState({
        sanciones: '',
        desde_fecha: '10/06/2020',
        hasta_fecha: '15/06/2020',
        observacion_preaviso: 'AAAAA'
    });
                        ...
                        <CardContent className="p-88 print:p-0">
                            ...
                            <div className="mt-44 print:mt-0">
                                ...
                                <Table className="simple">
                                    <TableBody>
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Art. 87. Cuando se trate de un contrato por tiempo indefinido, ninguna de las partes podrá terminarlo sin dar previo aviso a la otra, salvo lo dispuesto en los artículos 81 y 84 de este Código, conforme a las siguientes reglas:<br />
                                                a) cumplido el período de prueba hasta un año de servicio, 30 días de preaviso;<br />
                                                b) de más de un año y hasta cinco años de antigüedad, 45 días de preaviso;<br />
                                                c) de más de cinco y hasta diez años de antigüedad, 60 días de preaviso;<br />
                                                d) de más de diez años de antigüedad en adelante, 90 días de preaviso.<br />
                                                En el cómputo de la antigüedad se comprenderá el preaviso, si el trabajador prestó servicio durante ese tiempo<br />
                                                leer mas Art. 85 a 92<br />
                                        ...
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Desde Fecha</Typography>
                                            </TableCell>
                                            <TableCell align="right">
                                                {xml.desde_fecha}
                                            </TableCell>
                                        ...
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Hasta Fecha</Typography>
                                            </TableCell>
                                            <TableCell align="right">
                                                {xml.hasta_fecha}
                                            </TableCell>
                                        ...
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Observacion Preaviso</Typography>
                                            </TableCell>
                                            <TableCell align="right">
                                                {xml.observacion_preaviso}
                                            </TableCell>
                                        </TableRow>
                                    </TableBody>
                                </Table>
                            ...
                            <Grid container spacing={3}>
                                ...
                                <Grid item xs={12} md={3}>
                                    <div className="mt-96 print:mt-0 print:px-16">
                                        {(<QRCode value={`${process.env.REACT_APP_MTESS_PORTAL_URL}/kudepreavisos/${hashKude}`} />)}
                                    </div>
                                </Grid>
                            </Grid>
                        </CardContent>
