...
function KudeAccidentesLaborales(props) {
    ...
    const [xml, handleXml] = useState({
        sanciones: '',
        fecha_del_accidente: '10/06/2020',
        tipo_accidente: 'Aprisionamiento',
        naturaleza_del_accidente: 'Asfixia',
        agente_causante: 'agua',
        zonas_del_cuerpo_afectadas: 'dedos del pie',
        cuenta_con_equipos_proteccion: 'si',
        con_reposo: 'si',
        lugar_accidente: 'en la empresa',
        descripcion: 'AAAAA'
});
                        ...
                        <CardContent className="p-88 print:p-0">
                            ...
                            <div className="mt-44 print:mt-0">
                                ...
                                <Table className="simple">
                                    <TableBody>
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Art. 353. Las sanciones disciplinarias pueden consistir en: <br />
                                                a) suspensión del trabajo y salario, hasta ocho días; <br />
                                                b) simple amonestación verbal;<br />
                                                c) apercibimiento por escrito;<br />
                                                d) traslado del lugar de trabajo, de conformidad con el inciso n) del artículo 81;<br />
                                                e) postergación temporal de ascenso;<br />
                                                f) la enumeración precedente no implica orden de prelación ni jerárquico. Las partes podrán convenir otras medidas disciplinarias, no contrarias a este Código.<br />
                                                </Typography>
                                            </TableCell>
                                        ...
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Fecha del Accidente</Typography>
                                            </TableCell>
                                            <TableCell align="right">
                                                {xml.fecha_del_accidente}
                                            </TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Tipo Accidente</Typography>
                                            </TableCell>
                                            <TableCell align="right">
                                                {xml.tipo_accidente}
                                            </TableCell>
                                        ...
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Naturaleza del Accidente</Typography>
                                            </TableCell>
                                            <TableCell align="right">
                                                {xml.naturaleza_del_accidente}
                                            </TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Agente Causante</Typography>
                                            </TableCell>
                                            <TableCell align="right">
                                                {xml.agente_causante}
                                            </TableCell>
                                        ...
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Zonas del Cuerpo Afectadas</Typography>
                                            </TableCell>
                                            <TableCell align="right">
                                                {xml.zonas_del_cuerpo_afectadas}
                                            </TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Cuenta con Equipos Protección?</Typography>
                                            </TableCell>
                                            <TableCell align="right">
                                                {xml.cuenta_con_equipos_proteccion}
                                            </TableCell>
                                        </TableRow> <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Con Reposo</Typography>
                                            </TableCell>
                                            <TableCell align="right">
                                                {xml.con_reposo}
                                            </TableCell>
                                            ...
                                            <TableCell>
                                                <Typography variant="subtitle1">Lugar Accidente</Typography>
                                            </TableCell>
                                            <TableCell align="right">
                                                {xml.lugar_accidente}
                                            </TableCell>
                            ...
                            <Grid container spacing={3}>
                                ...
                                <Grid item xs={12} md={3}>
                                    <div className="mt-96 print:mt-0 print:px-16">
                                        {(<QRCode value={`${process.env.REACT_APP_MTESS_PORTAL_URL}/kudeaccidenteslaborales/${hashKude}`} />)}
                                    </div>
                                </Grid>
                            </Grid>
                        </CardContent>
...
export default KudeAccidentesLaborales;
