...
import ModernInvoicePageAguinaldo from '../invoice-format-atlas/ModernInvoicePageAguinaldo';
import ModernInvoicePagePago from '../invoice-format-atlas/ModernInvoicePagePago';
import ModernInvoicePageVacaciones from '../invoice-format-atlas/MoernInvoicePageVacaciones';
        ...
        async function LoadEmployee() {
            ...
            if (responseEmployee.status === 200) {
                var processedEmployee = {
                    ...
                    cargo: responseEmployee.data[0].employee.cargo
                }
