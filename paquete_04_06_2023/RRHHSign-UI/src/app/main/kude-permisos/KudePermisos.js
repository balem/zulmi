...
function KudePermisos(props) {
    ...
    const [xml, handleXml] = useState({
        sanciones: '',
        tipo_permiso: 'Casamiento',
        desde_fecha: '10/06/2020',
        hasta_fecha: '11/06/2020',
        motivo_permiso: 'Fin del Casamiento'
});
                        ...
                        <CardContent className="p-88 print:p-0">
                            ...
                            <div className="mt-44 print:mt-0">
                                ...
                                <Table className="simple">
                                    <TableBody>
                                        ...
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Tipo Permiso</Typography>
                                            </TableCell>
                                            <TableCell align="right">
                                                {xml.tipo_permiso}
                                            </TableCell>
                                        ...
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Motivo Permiso</Typography>
                                            </TableCell>
                                            <TableCell align="right">
                                                {xml.motivo_permiso}
                                            </TableCell>
                            ...
                            <Grid container spacing={3}>
                                ...
                                <Grid item xs={12} md={3}>
                                    <div className="mt-96 print:mt-0 print:px-16">
                                        {(<QRCode value={`${process.env.REACT_APP_MTESS_PORTAL_URL}/kudepermisos/${hashKude}`} />)}
                                    </div>
                                </Grid>
                            </Grid>
                        </CardContent>
