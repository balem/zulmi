...
function KudeEnfermedadesProfesionales(props) {
    ...
    const [xml, handleXml] = useState({
        sanciones: '',
        fecha_comunicacion: '10/06/2020',
        fecha_ultimo_examen_medico: '11/06/2020',
        domicilio_prestador_medico: 'Bahamas',
        tel_prestador_medico: '55(51)981781219'
});
                        ...
                        <CardContent className="p-88 print:p-0">
                            ...
                            <div className="mt-44 print:mt-0">
                                ...
                                <Table className="simple">
                                    <TableBody>
                                        ...
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Fecha Comunicación</Typography>
                                            </TableCell>
                                            <TableCell align="right">
                                                {xml.fecha_comunicacion}
                                            </TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Fecha Ultimo Examen Medico</Typography>
                                            </TableCell>
                                            <TableCell align="right">
                                                {xml.fecha_ultimo_examen_medico}
                                            </TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Domicilio Prestador Médico</Typography>
                                            </TableCell>
                                            <TableCell align="right">
                                                {xml.domicilio_prestador_medico}
                                            </TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Tel. Prestador Médico</Typography>
                                            </TableCell>
                                            <TableCell align="right">
                                                {xml.tel_prestador_medico}
                                            </TableCell>
                                        </TableRow>
                                    </TableBody>
                                </Table>
                            ...
                            <Grid container spacing={3}>
                                ...
                                <Grid item xs={12} md={3}>
                                    <div className="mt-96 print:mt-0 print:px-16">
                                        {(<QRCode value={`${process.env.REACT_APP_MTESS_PORTAL_URL}/kudeenfermedadesprofesionales/${hashKude}`} />)}
                                    </div>
                                </Grid>
                            </Grid>
                        </CardContent>
...
export default KudeEnfermedadesProfesionales;
