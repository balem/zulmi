                        ...
                        <CardContent className="p-88 print:p-0">
                            ...
                            <Table className="simple">
                                    <TableBody>
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Art. 218. Todo trabajador tiene derecho a un período de vacaciones remuneradas después de cada año de trabajo continuo al servicio del mismo empleador, cuya duración mínima será:<br />
                                                a) para trabajadores de hasta cinco años de antigüedad, doce días corridos;<br />
                                                b) para trabajadores con más de cinco años y hasta diez años de antigüedad, dieciocho días corridos;<br />
                                                c) para trabajadores con más de diez años de antigüedad, treinta días corridos.<br />
                                                leer mas en el art. 219 - 226<br />
                            </Typography>
                                            </TableCell>
                                        ...
                                        <TableRow>
                                            <TableCell>
                                                <Typography variant="subtitle1">Remuneración</Typography>
                                            </TableCell>
                                            <TableCell align="right">
                                                {xml.remuneracion}
                                            </TableCell>
                            ...
                            <Grid container spacing={3}>
                                ...
                                <Grid item xs={12} md={3}>
                                    <div className="mt-96 print:mt-0 print:px-16">
                                        {(<QRCode value={`${process.env.REACT_APP_MTESS_PORTAL_URL}/kudevacaciones/${hashKude}`} />)}
                                    </div>
                                </Grid>
                            </Grid>
                        </CardContent>
